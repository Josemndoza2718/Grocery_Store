  ...
  ChangeNotifierProvider(
      create: (context) => HomeViewModel(
            ...
            createProductsUseCases:
                CreateProductsUseCases(repository: ProductRepositoryImpl()),
            ...
            deleteProductsUseCases:
                DeleteProductsUseCases(repository: ProductRepositoryImpl()),
            updateProductsUseCases:
                UpdateProductsUseCases(repository: ProductRepositoryImpl()),
            //Clients
